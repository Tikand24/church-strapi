...
export interface ApiContactRequestContactRequest
  ...
  attributes: {
    ...
    subject: Schema.Attribute.Enumeration<
      ['intencion', 'sacramentos', 'voluntariado', 'otros']
    > &
      Schema.Attribute.Required &
...
export interface ApiFooterFooter extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ChurchInfo: Schema.Attribute.Component<'footer.church-info', false> &
      Schema.Attribute.Required;
...
export interface ApiLiturgicalEventLiturgicalEvent
  extends Struct.CollectionTypeSchema {
  collectionName: 'liturgical_events';
  info: {
    displayName: 'Liturgical Event';
    pluralName: 'liturgical-events';
    singularName: 'liturgical-event';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    color: Schema.Attribute.Enumeration<['verde', 'morado', 'blanco', 'rojo']>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    description: Schema.Attribute.Blocks;
    eventDate: Schema.Attribute.Enumeration<
      ['Lunes', 'Martes', 'Miercoles', 'Jueves', 'Viernes', 'Sabado', 'Domingo']
    > &
      Schema.Attribute.Required;
    eventType: Schema.Attribute.Enumeration<
      ['misa', 'adoracion', 'sacramento', 'celebracion especial']
    >;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::liturgical-event.liturgical-event'
    > &
      Schema.Attribute.Private;
...
export interface ApiNewsLetterSubscriptionNewsLetterSubscription
  ...
  info: {
    displayName: 'News letter subscription';
  ...
  attributes: {
    ...
    publishedAt: Schema.Attribute.DateTime;
    source: Schema.Attribute.String & Schema.Attribute.Required;
    statusSub: Schema.Attribute.Enumeration<
      ['active', 'unsubscribed', 'pending']
    > &
      Schema.Attribute.Required &
...
export interface ApiSacramentSacrament extends Struct.SingleTypeSchema {
  collectionName: 'sacraments';
  info: {
    displayName: 'Sacraments';
    pluralName: 'sacraments';
    singularName: 'sacrament';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    blocks: Schema.Attribute.DynamicZone<['more-info.more-info']>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    description: Schema.Attribute.Text;
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::sacrament.sacrament'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    sacramentList: Schema.Attribute.Component<'sacraments.sacrament', true>;
    Seo: Schema.Attribute.Component<'shared.seo', false>;
    title: Schema.Attribute.String & Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::sacrament.sacrament': ApiSacramentSacrament;
